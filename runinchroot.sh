...
dnsmasq hostapd \
\
bluez-firmware libbsd-dev libncurses5-dev libsndfile1-dev\
...
sed -i 's|^/usr/bin/bluealsa|/usr/bin/bluealsa -a2dp-sink|g' /etc/systemd/system/bluealsa.service # To be removed when solved in moode mainstream code
